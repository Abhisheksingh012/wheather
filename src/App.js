...
import GoggleTranslate from './components/GoggleTranslate';
...
let {data,status}=await axios.get(`http://localhost:3001/getdata?country=${pcountry}&city=${pct}&year=${dateForSearch[0]}&month=${dateForSearch[1]}&day=${dateForSearch[2]}&eyear=${query.get("date")?dateForSearch[0]:"2022"}`);
...
let res=await axios.get(`http://localhost:3001/getdata?country=${pcountry}&city=${pct}&year=1999&month=${dateForSearch[1]}&day=${dateForSearch[2]}&eyear=${query.get("date")?dateForSearch[0]:"2022"}&limit=100`);
...
let soilRes=await axios.get(`http://localhost:3001/soilMoisture?cnt=${pcountry}&ct=${pct}&date=${dateForSoil}`);
...
<div class="translatecon">
<div id="google_translate_element"></div>
<p class="translatetext" onClick={()=>{document.querySelector('#google_translate_element').style.display="block";document.querySelector('.translatetext').style.display="none";}}>Translate</p>
</div>
